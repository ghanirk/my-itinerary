  ...
  return (
    <div className="bg-brand-50 min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm bg-white border border-brand-100 rounded-lg p-8">
        <h1 className="font-heading text-2xl text-brand-700 mb-1">Masuk</h1>
        <p className="text-sm text-muted mb-6">Masuk untuk mulai menyusun plan perjalananmu.</p>
        ...
        <p className="text-sm text-muted text-center mt-6">
          Belum punya akun?{" "}
          <Link to="/register" className="text-brand-700 font-medium underline underline-offset-4">
            Daftar
          </Link>
        </p>
      </div>
